export class CazaRumores extends Phaser.Scene {
    ...
    obtenerSancionCaso(caso) {
        ...
        if (t.includes('reputación') || t.includes('reputacion')) {
    ...
    obtenerSignificadoBreveCaso(caso) {
        ...
        if (
            ...
            textoBase.includes('buen nombre')
        ) {
            return 'Protege la imagen de Valeria.';
        }
        ...
        if (
            ...
            return 'Frena la presión y el acoso.';
        }
    ...
    mostrarInformeFinal() {
        ...
        this.add.text(640, 64, 'INFORME DE CAZA RUMORES', {
            fontFamily: '"VT323", monospace',
            fontSize: '43px',
            color: '#40291a',
            stroke: '#fff0c8',
        ...
        this.add.text(640, 103, 'Culpables detectados durante el Día 3', {
            fontFamily: '"VT323", monospace',
            fontSize: '24px',
            color: '#5a3921'
        }).setOrigin(0.5).setDepth(depthBase + 2);
