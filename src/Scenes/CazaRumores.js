export class CazaRumores extends Phaser.Scene {
    ...
    obtenerLimitesMovimientoTarjetas(jugador) {
        return {
            ...
            // Para que no toque el HUD de Puntos/Ronda.
            minY: Math.max(305, jugador.minY + 20),

            // Para que tampoco se meta demasiado abajo.
    ...
    crearTarjetaRumor(jugador, base, x, y, ancho, alto) {
        ...
        const objetivo = {
            ...
            minX: this.obtenerLimitesMovimientoTarjetas(jugador).minX,
            maxX: this.obtenerLimitesMovimientoTarjetas(jugador).maxX,
            minY: this.obtenerLimitesMovimientoTarjetas(jugador).minY,
            maxY: this.obtenerLimitesMovimientoTarjetas(jugador).maxY,
